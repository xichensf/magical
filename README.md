...
Please check our paper "*Xi Chen et al. Mapping cell type regulatory triads modulated by disease from single-cell multiomics data. 2022*" for more details. Any questions about the technical details of the paper or about this MAGICAL package can be emailed to: Xi Chen, xchen@flatironinstute.org.
